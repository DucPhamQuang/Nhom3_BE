...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Kiểm tra nếu có hành động "remove"
    if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'remove') {
        ...
        if (isset($_SESSION['cart'])) {
            ...
            // Sắp xếp lại chỉ số của giỏ hàng
                                                ...
                                                <tr class="cart_item">
                                                    <td class="product-remove">
                                                        <a title="Remove this item" class="remove"
                                                            href="remove-item.php?id=<?= $product_id ?>"><?php echo $index++ ?></a>
                                                    </td>

                                                    <td class="product-thumbnail">
                                                        <a href="single-product.php?id=<?= $product_id ?>">
                                                    ...
                                                    <td class="product-name">
                                                        <a
                                                            href="single-product.php?id=<?= $product_id ?>"><?= htmlspecialchars($item['name']) ?></a>
                                                    </td>
